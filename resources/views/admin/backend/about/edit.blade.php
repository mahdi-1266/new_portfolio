...
<div class="row gx-4">
  <div class="col-lg-12 col-md-12 col-ms-12">
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form action="{{ route('update.about') }}" class="row" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="mb-3 col-lg-6 col-md-12 col-ms-12">
            ...
            @enderror" id="name" name="name" value="{{ $about->name }}">
          ...
          <div class="mb-3 col-lg-6 col-md-12 col-ms-12">
            <div class="">
              <img id="showImage" src="{{ asset($about->photo) }}" width="100" height="100" class="rounded-pill" alt="">
            </div>
          </div>

          <input type="hidden" class="form-control" name="id" value="{{ $about->id }}">

          <div class="mt-4 col-lg-12 col-md-12 col-ms-12">
