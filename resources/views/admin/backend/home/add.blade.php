...
<div class="row gx-4">
  <div class="col-lg-12 col-md-12 col-ms-12">
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form action="{{ route('store.home') }}" class="row" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="mb-3 col-lg-6 col-md-12 col-ms-12">
            ...
            @enderror" id="github_link" name="github_link" placeholder="Enter link">
          ...
          <div class="mb-3 col-lg-6 col-md-12 col-ms-12">
            ...
            @enderror" id="facebook_link" name="facebook_link" placeholder="Enter link">
          ...
          <div class="mb-3 col-lg-6 col-md-12 col-ms-12">
            ...
            @enderror" id="linkedin_link" name="linkedin_link" placeholder="Enter link">
          ...
          <div class="mb-3 col-lg-6 col-md-12 col-ms-12">
            ...
            @enderror" id="instagram_link" name="instagram_link" placeholder="Enter link">
